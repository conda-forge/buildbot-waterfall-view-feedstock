...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/buildbot-waterfall-view-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7329&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/buildbot-waterfall-view-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `buildbot-waterfall-view` can be installed with:

```
conda install buildbot-waterfall-view
```

It is possible to list all of the versions of `buildbot-waterfall-view` available on your platform with:
